...
if __name__ == '__main__':
    ...
    elif not os.path.exists('calculator_sub_model/checkpoint'):
        Calculator.sub_model()
    elif not os.path.exists('calculator_mul_model/checkpoint'):
        Calculator.mul_model()
    elif not os.path.exists('calculator_div_model/checkpoint'):
